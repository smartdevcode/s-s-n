...
class SimulationStartEvent(FinanceEvent):
    ...
    def from_json(self, json : dict):
        ...
        """
        return SimulationStartEvent(
            type=json['type'], timestamp=json['timestamp'], agentId=None, logDir=json['payload']['logDir']
        )
...
class SimulationEndEvent(FinanceEvent):
    ...
    def from_json(self, json : dict):
        ...
        """
        return SimulationEndEvent(
            type=json['type'], timestamp=json['timestamp'], agentId=None
        )
...
class LimitOrderPlacementEvent(OrderPlacementEvent):
    ...
    def from_json(self, json : dict):
        ...
        if json['type'] == 'RESPONSE_DISTRIBUTED_PLACE_ORDER_LIMIT':
            return LimitOrderPlacementEvent(
                type=json['type'], timestamp=json['timestamp'], agentId=json['payload']['agentId'],
                ...
                success=True,message=f"{'Buy' if json['payload']['payload']['requestPayload']['direction'] == 0 else 'Sell'} Limit Order {json['payload']['payload']['orderId']} placed successfully for {json['payload']['payload']['requestPayload']['volume']}@{json['payload']['payload']['requestPayload']['price']}!"
            )
    ...
    def from_json(self, json : dict):
        ...
        if json['type'] == 'RESPONSE_DISTRIBUTED_PLACE_ORDER_MARKET':
            return MarketOrderPlacementEvent(
                ...
                success=True,message=f"{'Buy' if json['payload']['payload']['requestPayload']['direction'] == 0 else 'Sell'} Market Order {json['payload']['payload']['orderId']} placed successfully for {json['payload']['payload']['requestPayload']['volume']}!"
            )
...
class OrderCancellationsEvent(FinanceEvent):
    ...
    def from_json(self, json : dict):
        ...
        Method to transform simulator format event message to the format required by the MarketSimulationStateUpdate synapse.
        """
        event = OrderCancellationsEvent(type=json['type'], timestamp=json['timestamp'], agentId=json['payload']['agentId'], bookId=json['payload']['payload']['requestPayload']['bookId'])
...
class ResetAgentsEvent(FinanceEvent):
    ...
    def from_json(self, json : dict):
        ...
        Method to transform simulator format event message to the format required by the MarketSimulationStateUpdate synapse.
        """
        event = ResetAgentsEvent(type=json['type'], timestamp=json['timestamp'], agentId=json['payload']['agentId'])
